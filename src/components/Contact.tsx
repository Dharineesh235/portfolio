      ...
      <div className='flex flex-col items-center gap-10'>
        ...
        <div className='flex flex-col w-full gap-10'>
          <div className='flex justify-center items-center'>
            <input ref={nameRef} type='text' className='input w-full bg-transparent p-3' placeholder='Name' />
          </div>
          <div className=' flex justify-center items-center'>
            <input ref={emailRef} type='text' className='input w-full bg-transparent p-3' placeholder='E-mail' />
          </div>
          <div className=' flex justify-center items-center'>
            <input ref={subjectRef} type='text' className=' input w-full bg-transparent p-3' placeholder='Subject' />
          </div>
          <div className='flex justify-center items-center'>
            <textarea ref={messageRef} className=' input w-full bg-transparent p-3 h-90' placeholder='Message' />
          </div>
          <div className='flex justify-center items-center'>
